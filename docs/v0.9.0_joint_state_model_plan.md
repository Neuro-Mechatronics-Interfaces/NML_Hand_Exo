...
> Status: **Implemented with documented scope decisions; bench validation pending.**
> This document preserves the original proposal. See the
> [v0.9.0 implementation contract](v0.9.0_implementation.md) for the final wire
> format, UTC synchronization, dynamics, safety-feedback exception, and the
> threshold-only scope of future assistance. `[EXISTING]` below refers to the
> implementation at the time this proposal was written.
...
<!-- graphviz:docs/figures/v0_9_0_telemetry_source_states.dot -->
![GraphViz diagram](figures/v0_9_0_telemetry_source_states.svg)
<!-- /graphviz:docs/figures/v0_9_0_telemetry_source_states.dot -->
