...
def main(argv: list[str] | None = None) -> int:
    ...
    subparsers.add_parser("emg-centroid", help="launch the EMG centroid direction decoder GUI")
    ...
    if args.command == "emg-centroid":
        ...
        if sys.path[0] != this_src:
            sys.path.insert(0, this_src)
        from nml_hand_exo.applications.emg_centroid_decoder_gui import (
            main as emg_centroid_main,
        )
