...
def library_info():
    ...
    version is used."""
    return lib.lsl_library_info().decode('utf-8', errors='replace')
...
class StreamInfo:
    ...
    def name(self):
        ...
        """
        return lib.lsl_get_name(self.obj).decode('utf-8', errors='replace')
    ...
    def type(self):
        ...
        """
        return lib.lsl_get_type(self.obj).decode('utf-8', errors='replace')
    ...
    def source_id(self):
        ...
        """
        return lib.lsl_get_source_id(self.obj).decode('utf-8', errors='replace')
    ...
    def uid(self):
        ...
        """
        return lib.lsl_get_uid(self.obj).decode('utf-8', errors='replace')
    ...
    def session_id(self):
        ...
        """
        return lib.lsl_get_session_id(self.obj).decode('utf-8', errors='replace')

    def hostname(self):
        """Hostname of the providing machine."""
        return lib.lsl_get_hostname(self.obj).decode('utf-8', errors='replace')
    ...
    def as_xml(self):
        ...
        """
        return lib.lsl_get_xml(self.obj).decode('utf-8', errors='replace')
...
class StreamInlet:
    ...
    def pull_sample(self, timeout=FOREVER, sample=None):
        ...
        if timestamp:
            ...
            if self.channel_format == cf_string:
                sample = [v.decode('utf-8', errors='replace') for v in sample]
    ...
    def pull_chunk(self, timeout=0.0, max_samples=1024, dest_obj=None):
        ...
        if dest_obj is None:
            ...
            if self.channel_format == cf_string:
                samples = [[v.decode('utf-8', errors='replace') for v in s] for s in samples]
...
class XMLElement:
    ...
    def name(self):
        """Name of the element."""
        return lib.lsl_name(self.e).decode('utf-8', errors='replace')

    def value(self):
        """Value of the element."""
        return lib.lsl_value(self.e).decode('utf-8', errors='replace')
